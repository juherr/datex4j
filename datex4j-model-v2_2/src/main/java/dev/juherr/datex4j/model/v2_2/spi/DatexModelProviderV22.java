 ...
 */
package dev.juherr.datex4j.model.v2_2.spi;

import dev.juherr.datex4j.core.DatexVersion;
import dev.juherr.datex4j.model.spi.DatexModelProvider;
import dev.juherr.datex4j.model.v2_2.D2LogicalModel;
import dev.juherr.datex4j.model.v2_2.ObjectFactory;
import dev.juherr.datex4j.model.v2_2.PayloadPublication;
import jakarta.xml.bind.JAXBElement;

/**
 * {@link DatexModelProvider} for the DATEX II v2_2 generated model. Registered through {@link
 ...
 */
public final class DatexModelProviderV22 implements DatexModelProvider {

    @Override
    public DatexVersion version() {
        return DatexVersion.V2_2;
    }

    @Override
    public String contextPath() {
        return "dev.juherr.datex4j.model.v2_2";
    }
