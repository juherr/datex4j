...
- **License:** **not stated** on the dataset page. transportdata.be's "About" page explicitly says
...
- **License:** **not restated** on the endpoint — treated as uncertain, so the feed is **never
