 ...
 */
package dev.juherr.datex4j.model.v3_1.spi;
...
/**
 * {@link DatexModelProvider} for the DATEX II v3_1 generated model. Registered through {@link
 * java.util.ServiceLoader}; see {@code META-INF/services/dev.juherr.datex4j.model.spi.DatexModelProvider}.
 */
public final class DatexModelProviderV31 implements DatexModelProvider {
    ...
    private static final String CONTEXT_PATH = String.join(
            ":",
            "dev.juherr.datex4j.model.v3_1.common",
            "dev.juherr.datex4j.model.v3_1.locationreferencing",
            "dev.juherr.datex4j.model.v3_1.situation",
            "dev.juherr.datex4j.model.v3_1.roadtrafficdata",
            "dev.juherr.datex4j.model.v3_1.vms",
            "dev.juherr.datex4j.model.v3_1.d2payload");

    @Override
    public DatexVersion version() {
        return DatexVersion.V3_1;
    }
