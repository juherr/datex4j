 ...
 */
package dev.juherr.datex4j.model.v2_3.spi;

import dev.juherr.datex4j.core.DatexVersion;
import dev.juherr.datex4j.model.spi.DatexModelProvider;
import dev.juherr.datex4j.model.v2_3.D2LogicalModel;
import dev.juherr.datex4j.model.v2_3.ObjectFactory;
import dev.juherr.datex4j.model.v2_3.PayloadPublication;
import jakarta.xml.bind.JAXBElement;

/**
 * {@link DatexModelProvider} for the DATEX II v2_3 generated model. Registered through {@link
 ...
 */
public final class DatexModelProviderV23 implements DatexModelProvider {

    @Override
    public DatexVersion version() {
        return DatexVersion.V2_3;
    }

    @Override
    public String contextPath() {
        return "dev.juherr.datex4j.model.v2_3";
    }
