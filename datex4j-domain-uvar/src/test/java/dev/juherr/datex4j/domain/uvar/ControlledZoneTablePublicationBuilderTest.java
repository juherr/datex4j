 ...
 */
package dev.juherr.datex4j.domain.uvar;
...
class ControlledZoneTablePublicationBuilderTest {

    @Test
    void buildsAndRoundtripsThroughDatexXml() {
        ControlledZoneTablePublication publication =
                ControlledZoneTablePublicationBuilder.controlledZoneTablePublication()
                        .publishedBy("gb", "datex4j-uvar")
                        .build();
