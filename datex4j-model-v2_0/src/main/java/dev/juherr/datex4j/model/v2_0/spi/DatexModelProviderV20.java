...
import dev.juherr.datex4j.model.v2_0.ObjectFactory;
import dev.juherr.datex4j.model.v2_0.PayloadPublication;
import jakarta.xml.bind.JAXBElement;

/**
 * {@link DatexModelProvider} for the DATEX II v2_0 generated model. Registered through {@link
 ...
 */
public final class DatexModelProviderV20 implements DatexModelProvider {

    @Override
    public DatexVersion version() {
        return DatexVersion.V2_0;
    }

    @Override
    public String contextPath() {
        return "dev.juherr.datex4j.model.v2_0";
    }
